...
export const GLOBAL_CALENDAR_NAME = "SRM AP Even Semester 2025-26 (Official)";
...
export const calendarOverrides: CalendarOverride[] = [
  ...
  // Day Swaps
  { date: "2026-04-22", type: "day_swap", followsDay: "Friday", reason: "Wednesday Following Friday Timetable" },
  { date: "2026-04-27", type: "day_swap", followsDay: "Friday", reason: "Monday Following Friday Timetable" }
];
...
export const isBlockCancelled = (date: Date, startTime: string, endTime: string, isLab: boolean): boolean => {
  const dateStr = formatDateLocal(date);
  return calendarOverrides.some(o => o.date === dateStr && o.type === "cancelled");
};
